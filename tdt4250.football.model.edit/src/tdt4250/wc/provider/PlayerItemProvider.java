...
/**
 * This is the item provider adapter for a {@link tdt4250.wc.Player} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PlayerItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addShirtNumberPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WcPackage.Literals.PLAYER__NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Shirt Number feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addShirtNumberPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Player_shirtNumber_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Player_shirtNumber_feature", "_UI_Player_type"),
				 WcPackage.Literals.PLAYER__SHIRT_NUMBER,
				 true,
				 false,
				 false,
